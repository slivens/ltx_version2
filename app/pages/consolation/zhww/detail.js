    ...
    render() {
        ...
        return (
            <div className={prefix}>
                <EditTopbar title="灾后慰问登记" onClick={() => this.props.history.goBack()}/>
                <Form className={prefix + "_detail"}>
                    ...
                    <WhiteSpace size="lg"/>
                    <List>
                        <List.Item extra={detailData.zhlxText}>灾害类型</List.Item>
                        <List.Item extra={detailData.zhfssj}>灾害发生时间</List.Item>
                        <List.Item extra={detailData.zhyxqk}>灾害影响情况</List.Item>
