        ...
        return (
            <div className={prefix}>
                ...
                <Form className={prefix + "_dj"} labelAlign="right"   labelCol={{ span: 6 }}
                    ...
                    <List>
                        <Form.Item >
                            {getFieldDecorator('zhlx', {
                                initialValue: detailData && detailData.jjrlx,
                                rules: [{required: true, message: '灾害类型'}],
                            })(
                                <Picker
                                    ...
                                    data={disasterData}
                                    cols={1}>
                                    <List.Item className={prefix + "_dj_date"} arrow="horizontal">灾害类型</List.Item>
                                </Picker>
                            )}
                        </Form.Item>

                        <Form.Item>
                            {getFieldDecorator('zhfssj', {
                                initialValue: detailData && new Date(detailData.zhfssj),
                                ...
                                <DatePicker
                                    ...
                                    extra="请选择灾害发生时间"
                                >
                                    <List.Item className={prefix + "_dj_date"} arrow="horizontal">灾害发生时间</List.Item>
                                </DatePicker>
                            )}
                        </Form.Item>
                        <Form.Item>
                            {getFieldDecorator('zhyxqk', {
                                initialValue: detailData && detailData.zhyxqk,
