...
import {caseData, zywwDetailInfoData,disasterData,sexData} from "../components/data";
                ...
                <div className={prefix + "-register-box"}>
                    ...
                    <Form className={prefix + "_dj"}>
                        ...
                        <List>
                            <List.Item arrow="horizontal">
                                <Form.Item>
                                    {getFieldDecorator('disasterType', {
                                        initialValue: [detailData && detailData.disasterType],
                                        ...
                                        <Picker
                                            ...
                                            data={disasterData}
                                            cols={1}>
                                            <List.Item className={prefix + "_dj_picker " + getEditClassName(detailData, "disasterType")}
                                            >
                                                {getInputItemTitle("灾害类型")}
                                            </List.Item>
                                        </Picker>
                                    )}
                                </Form.Item>
                            ...
                            <List.Item arrow="horizontal">
                                <Form.Item>
                                    {getFieldDecorator('disasterOccurTime', {
                                        initialValue: formatDate(detailData, "disasterOccurTime"),
                                        ...
                                        >
                                            <List.Item
                                                className={prefix + "_dj_picker " + getEditClassName(detailData, "disasterOccurTime")}
                                            >
                                                {getInputItemTitle("灾害发生时间")}
                                            </List.Item>
                                        </DatePicker>
                                    )}
                                </Form.Item>
                            ...
                            <List.Item className={prefix + "_dj_select"}>
                                <Form.Item>
                                    {getFieldDecorator('disasterImpact', {
                                        initialValue: detailData && detailData.disasterImpact,
                                        rules: [{required: true, message: '请输入灾害影响情况'}],
                                    })(
                                        <InputItem
                                            placeholder="请输入灾害影响情况"
                                            clear
                                        >  {getInputItemTitle("灾害影响情况")}</InputItem>
                                    )}
                                </Form.Item>
                            </List.Item>
